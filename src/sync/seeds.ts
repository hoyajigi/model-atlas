...
export const LLM_SEEDS: Seed[] = [
  ...
  { hf_id: 'deepseek-ai/DeepSeek-V4-Flash-Vision-Exp', org: 'deepseek', id: 'deepseek-v4-flash-vision-exp', family: 'deepseek-v4' },
...
export const T2I_SEEDS: Seed[] = [
  ...
  { hf_id: 'ideogram-ai/ideogram-4-fp8', org: 'ideogram-ai', id: 'ideogram-4', family: 'ideogram' }
]
